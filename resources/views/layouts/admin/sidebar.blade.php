...
<div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    ...
    <div class="aside-toolbar flex-column-auto" id="kt_aside_toolbar">
        ...
        <div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
            ...
            <div class="symbol symbol-50px">
                <img src="admin/assets/media/avatars/150-26.jpg" alt="" />
            </div>
            <!--end::Symbol-->
            <!--begin::Wrapper-->
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="admin/assets/media/avatars/150-26.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                            ...
                            <div class="scroll-y mh-200px mh-lg-350px">
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <img src="admin/assets/media/avatars/150-1.jpg" alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="admin/assets/media/avatars/150-3.jpg" alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column justify-content-start fw-bold">
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="admin/assets/media/avatars/150-8.jpg" alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column justify-content-start fw-bold">
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="admin/assets/media/avatars/150-11.jpg" alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column justify-content-start fw-bold">
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="admin/assets/media/avatars/150-12.jpg" alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column justify-content-start fw-bold">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('admin.index') }}">
                        ...
                        <span class="menu-title">Defaut</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="/">
                        ...
                        <span class="menu-title">Aller sur le site</span>
                    </a>
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('visitors.index') }}">
                        ...
                        <span class="menu-title">Visiteurs</span>
                    </a>
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">{{ Config('app.name') }} v 1.2</span>
                    </a>
                </div>
            </div>
            <!--end::Menu-->
    ...
    <div class="aside-footer flex-column-auto py-5" id="kt_aside_footer">
        <a href="#" class="btn  btn-danger w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="Passer en mode maintenance">
            <span class="btn-label">Mode maintenance</span>
            <!--begin::Svg Icon | path: icons/duotune/general/gen005.svg-->
